...
export const GradingView: React.FC<GradingViewProps> = ({ result }) => {
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 w-full max-w-full pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="p-5 bg-gradient-to-br from-purple-50 to-white rounded-2xl border border-purple-100 shadow-sm hover:shadow-md transition-shadow">
      ...
      {result.score < 10 && (
        <div className="bg-gray-900 text-white p-6 sm:p-8 rounded-3xl shadow-xl overflow-hidden relative">
